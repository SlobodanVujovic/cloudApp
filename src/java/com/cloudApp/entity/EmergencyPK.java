 ...
 */
@Embeddable
public class EmergencyPK implements Serializable {
    ...
    public EmergencyPK(int id, int companyOrderHasBrickCompanyOrderId, int companyOrderHasBrickBricksId) {
        this.id = id;
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof EmergencyPK)) {
            return false;
        }
        EmergencyPK other = (EmergencyPK) object;
        if (this.id != other.id) {
            return false;
        }
    ...
    public String toString() {
        return "com.cloudApp.entity.EmergencyPK[ id=" + id + ", companyOrderHasBrickCompanyOrderId=" + companyOrderHasBrickCompanyOrderId + ", companyOrderHasBrickBricksId=" + companyOrderHasBrickBricksId + " ]";
    }
